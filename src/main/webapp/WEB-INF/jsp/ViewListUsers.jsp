...
<div class="container col-12">
    ...
    <form:form cssClass="text-center" modelAttribute="conditionSearch" action="/manager/search" method="post">
        <table class="table table-striped table-primary text-dark table-hover">
            ...
            <tr>
                <%--<td>
                    <label for="startDate"></label><input type="date"  name="startDate" id="startDate" placeHolder="start date"/>
                </td>
                <td>
                    <label for="endDate"></label><input type="date"  name="endDate" id="endDate" placeHolder="end date"/>
                </td>--%>
                <td>
